...
modelParams.elecPosFile(modelParams.nElectrodes == 128) = cellstr('/media/diliberg/System/WS15/eeg/HEADMAPS/chanlocs_128');

modelParams.filesNum = 1:40; % 40 trials for each condition (slow / fast)
