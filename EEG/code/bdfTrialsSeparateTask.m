...
%          eeg(136,:) = eeg(130,:);
        ...
        if fileIdx == 1
            outputFileName = ['/media/diliberg/System/WS15/eeg/' subj '/' subj '_noTask_' num2str(trialCount) '.mat'];
        elseif fileIdx == 2
            outputFileName = ['/media/diliberg/System/WS15/eeg/' subj '/' subj '_task_' num2str(trialCount) '.mat'];
        end
