...
%                     y=y';
                ...
                disp(['Preprocessing ' filename]);
                load(filename); % sylCode, startIdx

                startSample = floor(startIdx(1)/44100*modelParams.fsOrig)+1;
                endSample = ceil(startIdx(end)/44100*modelParams.fsOrig+round(modelParams.fsOrig*0.8))+1; % Indeed, a single phoneme is shorter than 1 second
